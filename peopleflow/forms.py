...
class KioskForm(Form):
    ...
    company_logo = TextField('Company Logo', description="Provide the URL of the sponsor's logo. Best size: 715 X 508 pixels.", validators=[Required('The logo is required'), URL(message="Please provide a valid URL")])
